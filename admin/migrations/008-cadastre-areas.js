 ...
 * Приписка 4-го этажа (две зоны) снята до новых чертежей.
...
for (const u of cfg.units || []) {
  ...
  if (u.id === 'f4' && u.glaNote) { delete u.glaNote; changes++; console.log('✓ приписка 4-го этажа снята (до новых чертежей)'); }
}
