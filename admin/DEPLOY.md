...
5. Проверить форму заявки: тестовая заявка должна появиться в разделе
   **«Лиды»** панели, а письмо — прийти на почту проекта (первое письмо от
   FormSubmit попросит одноразовое подтверждение почты). Дубль в Google
   Таблицу — опционально, поле «Google Таблица» на вкладке «Основное»
