...
<div class="pg">
  ...
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:5mm">
    ...
    ${kpi('Арендный доход', '22,05%', 'на арендопригодный метр; 16,25% на всю купленную площадь')}
  </div>
  <div class="itwo" style="margin-top:7mm">
    <div class="icard">
      ...
      ${ul(['<b>Капитализация.</b> Вход на этапе строительства, выход после ввода и кадастра. Прибыль 1 140 $ с каждого квадратного метра.',
            '<b>Арендный бизнес.</b> Удержание актива, поток 300 $ с арендопригодного метра в год: окупаемость 4,5 года на этот метр и 6,2 года на всю купленную площадь.',
