...
// 4 титульных листа основной брошюры + 17 страниц инвестиционной части
const count = 4 + 17;
...
<div class="pg">
  ...
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:5mm">
    ${kpi('Арендный поток', '$300 /м² в год', 'при ставке 25 $/м² в месяц')}
    ${kpi('Доходность к цене покупки', '22,05%', 'от 1 360 $/м², цена этапа строительства')}
    ${kpi('Доходность к рыночной стоимости', '12,00%', 'от 2 500 $/м², ориентир на момент готовности')}
  </div>
  <div class="itwo" style="margin-top:7mm">
    <div class="icard">
      <div class="ih3">Два способа считать доходность</div>
      ${ul(['<b>К цене покупки (yield on cost).</b> 300 $ годового потока к 1 360 $ вложений - 22,05%. Показывает доходность именно ваших вложений на этапе строительства.',
            '<b>К рыночной стоимости (yield on value).</b> Те же 300 $ к 2 500 $ - ориентировочной стоимости объекта после ввода - 12,00%. Показывает доходность так, как её увидит покупатель актива после ввода.'])}
    </div>
    <div class="icard acc">
      <div class="ih3">Почему разница важна</div>
      ${ul(['22,05% - ваша реальная доходность, потому что вы вошли по цене стройки.',
            '12,00% - ориентир, с которым актив будет сравниваться на рынке готовых бизнес-центров после ввода.',
            'Окупаемость вложений при доходности к цене покупки - 4,5 года.'])}
    </div>
  </div>
  <div class="inote" style="margin-top:5mm">В радиусе около 1 км от Botanica уже работают другие бизнес-центры, аренда в них начинается от 25 $/м² в месяц - ставка 25 $/м², заложенная в модели, подтверждена соседним рынком, а не завышена.</div>
  ${foot()}
</div>
...
<div class="pg">
  ...
  <div class="itwo">
    <div style="display:flex;flex-direction:column;gap:5mm;min-height:0">
      ...
      <div class="inote">Сток классов A и B приведён без учёта трёх башен Tashkent City (более 220 тыс. м²). Источники: аналитика рынка 2024-2025 и данные собственника, июль 2026 года.</div>
    </div>
...
<div class="pg">
  ...
  <div class="ih">Независимая аналитика подтверждает картину</div>
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:5mm">
    ${kpi('Рост цен офисов', '+25%', 'за год, рынок Ташкента в целом')}
    ${kpi('Вакантность', '16%', 'упала с 25% за год: рынок поглощает качество')}
    ${kpi('Ставки класса B', '+13%', 'за год')}
    ${kpi('Наш вход к рынку', '-35%', '1 360 $/м² против ориентира ~2 100 $/м² сегодня')}
  </div>
  <div class="itwo" style="margin-top:7mm">
    <div class="icard">
      <div class="ih3">Пример: как растут цены на стройке</div>
      ${ul(['Бизнес-центр класса A Centris Towers подорожал на 105% за 2 года строительства.',
            ...
            'Наш ориентир по Botanica скромнее: 83,8% за цикл около 14 месяцев, с расчётом на странице «Перепродажа и прибыль на выходе».'])}
    </div>
    <div class="icard acc">
      ...
      ${ul(['Дефицит качества: спрос смещается на офисы с отделкой в сильных локациях, устаревшие простаивают.',
            'Дисконт входа 35% к текущему рыночному ориентиру - независимое подтверждение, что цена 1 360 $/м² ниже рынка уже сегодня, без ожидания роста.'])}
    </div>
  </div>
  <div class="inote" style="margin-top:5mm">Источник: независимый инвестиционный обзор «Botanica» - REDREAM Real Estate & Investment, 2026. Цифры приведены как внешняя рыночная аналитика, отдельно от расчётов CASE на соседних страницах.</div>
  ${foot()}
</div>
...
<div class="pg">
  ...
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:5mm">
    ...
    ${kpi('Оценка под БЦ', '92 / 100', 'при городской медиане 83')}
  ...
  <div class="itwo" style="margin-top:7mm">
    <div class="icard">
      ...
      ${ul(['Участок считали двумя форматами: клиника и бизнес-центр. По обоим он выше городской медианы, но масштаб конкуренции отличается на порядок.',
            ...
            'Медицинский рынок вокруг зрелый: 151 профильная клиника в 3 км. Офисной конкуренции в километре нет вовсе.'])}
    </div>
    <div class="icard acc">
  ...
  <div class="inote" style="margin-top:5mm">Источник: гео-аналитическая платформа CASE (1 530 медучреждений, 1 027 аптек, 150 бизнес-центров, сетка населения по городу), сбор из открытых источников, июль 2026. Ограничение обоих форматов - парковка: открытых данных нет, считается отдельно.</div>
  ${foot()}
</div>
...
<div class="pg">
  ...
  <div style="display:flex;gap:8mm;flex:1;min-height:0">
    <div style="flex:1.1">
      <table class="itab">
        ...
        ${rows([
          ...
          ['Чистая прибыль с квадратного метра', '1 140 $'],
          ['Возврат на вложенное (ROI)', '83,8%'],
          ['Горизонт цикла', 'около 14 месяцев'],
          ['Годовая доходность (IRR)', '65-70%']
        ])}
      </table>
      <div class="inote" style="margin-top:4mm">Расчёт собственника. Цена выхода - ориентир по рынку на момент получения кадастра, а не гарантированная величина.</div>
    </div>
    <div style="flex:.9;display:flex;flex-direction:column;gap:5mm">
      ...
      <div class="icard acc">
        <div class="ih3">Что определяет результат</div>
        ${ul(['Срок ввода объекта и получения кадастра.',
              'Состояние рынка в 2027 году и глубина поглощения профицита.',
              'Объём лота: крупный блок торгуется иначе, чем отдельный этаж.'])}
      </div>
    </div>
  </div>
    ...
    <div style="flex:1.1">
      <table class="itab">
        ...
        ${rows([
          ...
          ['Годовой арендный поток с 1 м²', '300 $'],
          ['Валовая рентная доходность', '22,05% годовых в валюте'],
          ['Срок окупаемости', '4,5 года, то есть 54 месяца'],
          ['Ориентир эксплуатационных затрат', 'около 3 $/м² в месяц']
        ])}
      </table>
      <div class="inote" style="margin-top:4mm">Доходность указана до вычета эксплуатационных расходов, налогов и простоя. Чистая доходность считается индивидуально в финансовой модели CASE.</div>
    </div>
    <div style="flex:.9;display:flex;flex-direction:column;gap:5mm">
      <div class="icard">
        <div class="ih3">Здание целиком</div>
        ${ul(['GLA 2 575,4 м² при ставке 25 $/м² - около 773 тыс. $ валового дохода в год.',
              'При заполняемости 90% - около 695 тыс. $ в год.',
              'Рыночная ставка класса A сегодня 32-34 $/м², то есть в расчёте заложен запас.'])}
      </div>
      <div class="icard acc">
        <div class="ih3">Кому подходит</div>
        ${ul(['Инвестору, которому нужен валютный поток, а не разовая прибыль.',
              'Компании, готовой занять часть здания и сдавать остальное.',
              'Фонду, который заходит на стройке и выходит после стабилизации.'])}
      </div>
    </div>
  </div>
  ${foot()}
...
<div class="pg">
  ...
  <div style="font-size:10pt;line-height:1.5;color:${MUTED};margin-bottom:5mm;max-width:210mm">
    Поле показывает путь коммерческого объекта от идеи до выхода из актива. Движение начинается с клетки СТАРТ в правом нижнем углу и идёт против часовой стрелки. Каждая сторона поля - одна фаза жизненного цикла. Клетки ШАНС и угловые клетки - события, которые случаются не с каждым проектом, но меняют экономику сразу.
  </div>
  <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:5mm;flex:1;min-height:0">
    ${[[1, 'нижняя сторона', BOTTOM, 'От поиска локации до утверждённой концепции. Здесь проект стоит дешевле всего и здесь же зарабатывается первый множитель стоимости.'],
       ...
       [3, 'верхняя сторона', TOP, 'Затраты без выручки. Botanica находится здесь: конструктив и инженерия, параллельно идёт предброкеридж.'],
  ...
  <div class="board">
    ...
    <div class="bmid">
      ...
      <div class="blegend">
        ...
        <em style="margin-left:auto">Движение против часовой стрелки от клетки СТАРТ</em>
      </div>
    </div>
  </div>
