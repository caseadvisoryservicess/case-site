...
CFG = {
  ...
  "photos": {
    "nav": ml("Фотографии", "Fotosuratlar", "Photos"),
    "lbl": ml("Фотографии", "Fotosuratlar", "Photographs"),
    "h2": ml("Помещение изнутри", "Maydon ichkaridan", "Inside the space"),
    "sub": ml(
      "Съёмка сделана в помещении. Мебель, светильники, посуда, бар и кухонное оборудование на снимках остаются новому арендатору.",
      "Suratga olish maydonning o'zida qilingan. Suratlardagi mebel, chiroqlar, idishlar, bar va oshxona jihozlari yangi ijarachiga qoladi.",
      "The photographs were taken on site. The furniture, light fittings, tableware, bar and kitchen equipment shown remain for the new tenant."),
    "note": ml("Фотографии сделаны в помещении и не являются публичной офертой.",
               "Fotosuratlar maydonning o'zida olingan va ommaviy oferta hisoblanmaydi.",
               "The photographs were taken on site and do not constitute a public offer."),
    "images": [
      {"file": "hall-wide.jpg", "span": "wide",
       "badge": ml("основной зал", "asosiy zal", "main dining room"),
       "alt": ml("Основной зал ресторана: мраморный пол, люстры, диваны и столы на 279,7 м²",
                 "Restoranning asosiy zali: marmar pol, qandillar, divanlar va stollar",
                 "The main dining room: marble floor, chandeliers, banquettes and tables")},
      {"file": "bar.jpg",
       "badge": ml("бар и раздача", "bar va tarqatish", "bar and service counter"),
       "alt": ml("Бар и линия раздачи ресторана с чёрной столяркой и открытыми полками",
                 "Restoranning bari va tarqatish liniyasi, qora yog'och va ochiq javonlar bilan",
                 "The bar and service line with black joinery and open shelving")},
      {"file": "lounge-bay.jpg",
       "badge": ml("диванная зона", "divan zonasi", "lounge seating"),
       "alt": ml("Диванная зона ресторана у высоких окон с бордовыми шторами",
                 "Baland derazalar yonidagi divan zonasi, bordo pardalar bilan",
                 "Lounge seating by tall windows with burgundy curtains")},
      {"file": "lounge.jpg",
       "badge": ml("зал у окон", "deraza yonidagi zal", "window seating"),
       "alt": ml("Мягкие диваны и столы у окон, вид на второй зал ресторана",
                 "Deraza yonidagi yumshoq divanlar va stollar, ikkinchi zalga ko'rinish",
                 "Upholstered banquettes and tables by the windows, looking into the second room")},
      {"file": "hall-wood.jpg",
       "badge": ml("второй зал", "ikkinchi zal", "second room"),
       "alt": ml("Второй зал ресторана с деревянным полом ёлочкой и мягкими диванами",
                 "Yog'och polli ikkinchi zal, yumshoq divanlar bilan",
                 "The second dining room with a herringbone wooden floor and soft banquettes")},
      {"file": "kitchen.jpg",
       "badge": ml("кухня", "oshxona", "kitchen"),
       "alt": ml("Профессиональная кухня: вытяжной зонт, тепловое оборудование, производственные столы",
                 "Professional oshxona: so'rg'ich, issiqlik jihozlari, ishlab chiqarish stollari",
                 "The professional kitchen: extraction hood, cooking line and prep counters")},
      {"file": "terrace.jpg", "span": "wide",
       "badge": ml("терраса 47,7 м²", "terrassa 47,7 m²", "terrace 47.7 m²"),
       "alt": ml("Остеклённая терраса с раздвижным навесом, столами и плетёными креслами",
                 "Suriladigan soyabonli oynali terrassa, stollar va to'qilgan kreslolar bilan",
                 "The glazed terrace with a retractable canopy, tables and woven armchairs")},
      {"file": "entrance.jpg",
       "badge": ml("входная группа", "kirish guruhi", "entrance"),
       "alt": ml("Входная группа ресторана: мраморный пол, латунная вывеска, люстра",
                 "Restoran kirish guruhi: marmar pol, latun peshlavha, qandil",
                 "The restaurant entrance: marble floor, brass signage and a chandelier")},
      {"file": "passage.jpg",
       "badge": ml("проход к выходу", "chiqishga o'tish", "passage to the exit"),
       "alt": ml("Проход между залами к отдельному выходу на улицу",
                 "Zallar orasidagi o'tish, ko'chaga alohida chiqish tomon",
                 "The passage between the rooms leading to the separate street exit")},
      {"file": "restroom.jpg",
       "badge": ml("санузел", "hojatxona", "restroom"),
       "alt": ml("Санузел для гостей: мрамор, мозаика, золотая фурнитура",
                 "Mehmonlar uchun hojatxona: marmar, mozaika, oltin rangli furnitura",
                 "Guest restroom: marble, mosaic tiling and brass fittings")},
      {"file": "lobby.jpg",
       "badge": ml("лобби отеля", "mehmonxona lobbisi", "hotel lobby"),
       "alt": ml("Лобби отеля Mercure: из него ведёт прямой вход в ресторан",
                 "Mercure mehmonxonasi lobbisi: undan restoranga to'g'ridan-to'g'ri kirish bor",
      ...
      {"file": "facade-terrace.jpg",
       ...
       "alt": ml("Отдельный вход с улицы и остеклённая терраса ресторана со стороны фасада",
                 "Ko'chadan alohida kirish va fasad tomondan restoranning oynali terrassasi",
                 "The separate street entrance and the glazed terrace seen from the street")}
    ]
  },
