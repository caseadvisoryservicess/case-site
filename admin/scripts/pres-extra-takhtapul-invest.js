...
const MAP_DEFS = [
  { file: 'caseos-map.jpg', h: 'Окружение объекта на карте',
    c: 'Экспорт карты из приложения CASE OS Geo Analytics, подложка OpenStreetMap. Точками показаны медицинские объекты (слой OSM и clinics.uz) и бизнес-центры, у ближайших подписаны названия. Охват кадра около 3,9 на 2,9 км, объект в центре.' },
