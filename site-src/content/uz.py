...
L = {
    ...
    "home": {
        ...
        "scen_lead": "Arxitektor rasm koʻrsatadi. Biz raqamlardan qaror qanday tugʻilishini koʻrsatamiz. Pastga tushing: bitta yer uchastkasi dastur orqali oʻtib, uchta boshqa obyektga aylanadi.",
        "scen_depth": "qaror chuqurligi",
        "scen_steps": [
            {"t": "Yer uchastkasi", "d": "Chegaralari, kirish yoʻllari va qurilish cheklovlari boʻlgan boʻsh maydon. Bu darajada qaror yoʻq, faqat ramka bor."},
            {"t": "Gabarit", "d": "Ramka ichiga ruxsat etilgan eng katta hajm joylashtiriladi. Bu hali loyiha emas: bu shift, undan keyin faqat ayiriladi."},
            {"t": "A stsenariy. Maksimal savdo", "d": "Butun maydon savdoga berilgan. Tez toʻlish, bitta talab manbaiga va langar ijarachiga yuqori bogʻliqlik. Langar ketsa, butun obyekt qulaydi."},
            {"t": "B stsenariy. Aralash dastur", "d": "Savdo qoʻshimcha ofis yoki xizmat bilan. Kvadrat metrga choʻqqi daromad pastroq, barqarorlik yuqoriroq: ikki xil oqim tsiklning turli fazalarida ijara toʻlaydi."},
            {"t": "C stsenariy. Ushlab turishga qaratilgan", "d": "Ijaraga beriladigan maydon kamroq, jamoat maydoni va parkovka koʻproq. Boshlangʻich tushum pastroq, takroriy tashriflar va oʻrtacha chek uzoq muddatda yuqoriroq."},
            {"t": "Qaror", "d": "Bitta uchastkadagi uchta dastur uchta boshqa obyekt va uchta boshqa pul oqimini beradi. Farq shu yerda, loyihalashdan oldin koʻrinadi, ochilishdan keyin emas."},
        ],
        "scen_legend": ["Savdo", "Ofis va xizmat", "Jamoat maydoni va parkovka"],
        "scen_note": "Kesim va ulushlar sxematik: ular mexanikani koʻrsatadi, aniq obyekt boʻyicha hisobni emas. Haqiqiy qiymatlar moliyaviy modeldan qoʻyiladi.",
    ...
    "feasibility": {
        ...
        "stand_inputs": [
            ("Ijara stavkasi", "$/m2 oyiga"),
            ("Boʻsh maydon", "%"),
            ("Ochilish kechikishi", "oy"),
        ],
        "stand_assumptions_title": "Stend farazlari",
        "stand_assumptions": [
            "GLA 20 000 m2, toʻliq ijaraga berilgan",
            "OPEX yalpi daromadning 30 foizi",
            "Qarz 18 mln USD, 12 foiz, 10 yil muddat",
            "Qarz xizmati annuitet sifatida hisoblanadi",
        ],
        "stand_noi": "Yiliga operatsion daromad",
        "stand_debt": "Yiliga qarz xizmati",
        "stand_result": "DSCR",
        "stand_ok": "Yoʻlak ichida",
        "stand_bad": "1,30 dan past: bank bunday hisobni qabul qilmaydi",
        "stand_threshold": "chegara 1,30",
        "stand_disclaimer": "Oʻquv stendi. Undagi barcha raqamlar shartli va siz tomoningizdan kiritilgan. Bu sizning obyektingiz boʻyicha hisob emas va investitsiya tavsiyasi emas.",
        "s5_num": "06",
