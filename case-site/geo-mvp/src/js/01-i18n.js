...
(function (w) {
  ...
  I.en = {
    ...
    'basemap.note': 'The background only. Markers, districts, radii and every figure are ours and do not change with it.',
    'basemap.osm': 'OpenStreetMap',
    'basemap.osm.attribution': '© OpenStreetMap contributors',
    'basemap.osmHot': 'OpenStreetMap – Humanitarian',
    'basemap.osmHot.attribution': '© OpenStreetMap contributors · Tiles by HOT',
    'basemap.cartoLight': 'CARTO Positron – light',
    'basemap.cartoDark': 'CARTO Dark Matter',
    'basemap.carto.attribution': '© OpenStreetMap contributors © CARTO',
    'basemap.esriImagery': 'Esri – satellite imagery',
    'basemap.esri.attribution': 'Imagery © Esri, Maxar, Earthstar Geographics',
    'basemap.openTopo': 'OpenTopoMap – terrain',
    'basemap.openTopo.attribution': '© OpenStreetMap contributors · SRTM · OpenTopoMap (CC-BY-SA)',
    'basemap.2gis': '2GIS',
    'basemap.google': 'Google Maps',
    'basemap.yandex': 'Yandex Maps',
    'basemap.none': 'No base map – grid only',
    'basemap.none.note': 'The neutral graticule. Also what you get automatically when the tiles cannot be reached.',

    /* The three licensed providers. Each line says the ONE thing that unlocks
       it, because "unavailable" without a remedy is not useful to anybody. */
    'basemap.licensed': 'Needs a licence',
    'basemap.2gis.needs': 'Requires a 2GIS licence agreement. Paste the tile endpoint from your contract to enable it.',
    'basemap.google.needs': 'Google tiles may be used only through the Maps JavaScript API with a billing-enabled key – not as direct tiles. Paste a licensed endpoint to enable it.',
    'basemap.yandex.needs': 'Requires a Yandex Maps API licence. Paste the tile endpoint from your agreement to enable it.',
    'basemap.yandex.projection': 'Caution: Yandex draws its base map in EPSG:3395, while this map and every other provider use EPSG:3857. Without reprojection the tiles sit a few hundred metres off our markers at this latitude.',
    'basemap.endpoint.label': 'Licensed tile endpoint',
    'basemap.endpoint.placeholder': 'https://…/{z}/{x}/{y}.png',
    'basemap.endpoint.save': 'Use this endpoint',
    'basemap.endpoint.clear': 'Remove',
    'basemap.endpoint.invalid': 'That is not a tile template – it must contain {z}, {x} and {y}.',
    'basemap.endpoint.insecure': 'The endpoint must be https.',
    'basemap.endpoint.storeFailed': 'This browser would not store the endpoint, so it will last only for this session.',
    'basemap.endpoint.saved': '{name} is now available as a base map.',
    'basemap.endpoint.removed': '{name} is licensed again – its endpoint was removed.',
    'basemap.switched': 'Base map: {name}',
    'basemap.unavailable': '{name} could not be reached. The grid is showing instead.',
