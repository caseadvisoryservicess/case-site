...
(async () => {
  ...
  ck('модули зарегистрированы: инструменты и компоновка 4.76.0, агент, дерево, geo-direct 4.75.0', v.tools === '4.76.0' && v.layout === '4.76.0' && v.agent === '4.75.0' && v.tree === '4.75.0' && v.direct === '4.75.0', JSON.stringify([v.tools, v.layout, v.agent, v.tree, v.direct]));
