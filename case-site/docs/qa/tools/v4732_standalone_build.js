...
(async () => {
  ...
  ck('внешних скриптов нет, все шестнадцать встроены (с v4.77.0 махалли и демография, сторона дороги, профили; с v4.78.0 НГИС)', !/<script src=/.test(html) && r.inlined.length === 16 && r.inlined.indexOf('v4770-geo-mahalla.js') >= 0 && /window\.CASE_DEMOGRAPHY=/.test(html) && r.inlined.indexOf('geo-direct.js') >= 0 && r.inlined.indexOf('v4740-geo-tree.js') >= 0 && r.inlined.indexOf('v4750-geo-layout.js') >= 0 && r.inlined.indexOf('v4750-geo-tools.js') >= 0 && r.inlined.indexOf('v4760-geo-bc.js') >= 0 && r.inlined.indexOf('v4760-geo-caps.js') >= 0, r.inlined.join(', '));
