...
и показатели районов, генплан и налоговые зоны в точке, участки; модуль НГИС из браузера.
...
7 419 зон, налоговые зоны, 90 113 нежилых участков; сырые файлы в репозиторий не кладутся).
...
строке (вручную > код > ближайшая к центру), считает площадь, плотность, участки; для района
