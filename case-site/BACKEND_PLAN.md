...
> **Обновление:** по решению — бэкенд **самостоятельный, на вашем хостинге
> (PHP + MySQL)**, без внешних сервисов. Реализация: `os/api/` (PHP) и
> `os/sql/` (схема MySQL), установка — `os/api/README.md`. Концепция ниже
> (таблицы, роли, права) сохранена; вместо Supabase RLS права проверяются
> в PHP, вместо Supabase Auth — логин по email/паролю (bcrypt) и сессии.
