...
(function(){
  ...
  var CURRENT_CORE=['dash','v32_action','dates','work_tasks','work_kanban','workload','work_approvals','crm_clients','leasing_portfolio_map','project_workspace','project_layouts','plan_master','case_projects','docs','registry','brands','v32_demand','v32_requests','v32_sales','v32_investors','v32_partners','v326_lease','plans','feasibility','mep','lift','map','analytics_hub','geoanalytics','bench','kpi','org','study','rating','users','admin_modules','admin_system'];
  var DEFAULTS={
    ASH:ALL.slice(), CFO:ALL.slice(), ADM:ALL.slice(),
    BA:['dash','v32_action','dates','work_tasks','work_kanban','workload','work_approvals','crm_clients','leasing_portfolio_map','project_workspace','project_layouts','plan_master','case_projects','project_handover','docs','registry','brands','v32_demand','v32_requests','v32_sales','v32_investors','v32_partners','v326_lease','leasing_layouts','plans','leasing_opening','feasibility','mep','map','analytics_hub','geoanalytics','bench','kpi','org','study','rating'],
    AG:['dash','v32_action','dates','work_tasks','work_kanban','workload','work_approvals','crm_clients','leasing_portfolio_map','project_workspace','project_layouts','plan_master','case_projects','docs','registry','brands','v32_demand','v32_requests','v32_sales','v32_investors','v326_lease','leasing_layouts','plans','leasing_opening','map','analytics_hub','geoanalytics','kpi','org','study','rating'],
    AGX:['dash','v32_action','dates','work_tasks','work_kanban','leasing_portfolio_map','case_projects','docs','registry','brands','v32_demand','v32_requests','v32_sales','v32_investors','v326_lease'],
