...
(function () {
  ...
  var VERSION = '4.76.0', DEMO_N = 40, CENTER = [41.3111, 69.2797];
  ...
  function readCaps() {
    ...
    if (c.export == null) c.export = true; if (c.edit == null) c.edit = true; c.demo = !!c.demo;
    return c;
  }
  function css() {
    ...
    var s = document.createElement('style'); s.id = 'geoCapsCss'; s.textContent =
      ...
      + '.geo-demo .tabs button[data-t="dataT"]{display:none!important}';
  ...
  function trimDemo() {
    ...
    try { var hc = $('hdrCount'); if (hc) hc.textContent = list.length + ' БЦ · демо'; } catch (e) {}
  ...
  function apply(caps) {
    ...
    if (caps.demo || !caps.export || !caps.edit) banner(caps);
  }
  ...
  function install() {
    ...
    (function tick() {
      ...
      if (caps.type === 'full' && caps.export && caps.edit && !caps.demo) return;
...
window.CASE_MODULE_VERSIONS = window.CASE_MODULE_VERSIONS || {}; window.CASE_MODULE_VERSIONS['v4760-geo-caps'] = '4.76.0';
