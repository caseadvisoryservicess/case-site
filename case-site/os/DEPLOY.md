# CASE OS v4.62.0 - краткая установка

Что вошло в релиз: `CHANGELOG_CASE_OS_v4.62.0.md` в корне пакета.
...
2. Ctrl+Shift+R. В шапке `v4.62.0`.
...
Миграций базы нет. Включает v4.52.0-v4.61.1.

Проверка после заливки: в консоли браузера должно быть `CASE OS: все модули версии 4.62.0`,
...
Целостность: `sha256sum -c SHA256SUMS_v4.62.0.txt` из папки `/os`.
