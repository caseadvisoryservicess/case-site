# CASE OS v4.61.1 - краткая установка

Что вошло в релиз: `CHANGELOG_CASE_OS_v4.61.1.md` в корне пакета.
...
2. Ctrl+Shift+R. В шапке `v4.61.1`.
...
Миграций базы нет. Включает v4.52.0-v4.61.0.

Проверка после заливки: в консоли браузера должно быть `CASE OS: все модули версии 4.61.1`,
...
Целостность: `sha256sum -c SHA256SUMS_v4.61.1.txt` из папки `/os`.
