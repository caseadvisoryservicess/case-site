# CASE OS v4.60.0 - краткая установка

Что вошло в релиз: `CHANGELOG_CASE_OS_v4.60.0.md` в корне пакета.
...
2. Ctrl+Shift+R. В шапке `v4.60.0`.

Изменены `api/gis_proxy.php`, `index.html`, `core.js`, `sw.js`, `v4450-ux-system.js`, `v4451-live-sync.js`,
...
Миграций базы нет. Включает v4.52.0-v4.59.0.

Проверка после заливки: в консоли браузера должно быть `CASE OS: все модули версии 4.60.0`,
...
Целостность: `sha256sum -c SHA256SUMS_v4.60.0.txt` из папки `/os`.
