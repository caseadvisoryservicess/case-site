-- CASE OS — схема MySQL/MariaDB (бэкенд на вашем хостинге).
-- Импорт: cPanel → phpMyAdmin → выбрать БД → Import → этот файл.
-- Кодировка utf8mb4. JSON-поля хранятся как JSON/LONGTEXT.
