...
return [
  ...
  // v4.78.0: бесплатный ограниченный доступ «Ищу офис» открывается при регистрации сразу (40 БЦ, без выгрузки и правок).
  // Выключить (такие заявки будут ждать администратора): раскомментируйте строку.
