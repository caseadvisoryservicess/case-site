...
@media (max-width:820px){:root{--case-touch:44px}.topbar{gap:6px}.gsearch{order:5!important;width:100%!important;min-width:100%!important}.btn,.btn.sm,.thbtn,.langbtn,.tabs button,.geo-tabbar button{min-height:44px!important}.ph{align-items:flex-start}.ph>div{margin-left:0;width:100%}.ph>div .btn{flex:1}.case-dashboard-mode{width:100%;display:grid;grid-template-columns:1fr 1fr}.case-dashboard-mode button{min-height:44px}.tbl-scroll-top{position:sticky;top:var(--topbar-h,55px);z-index:16;background:var(--panel);padding-top:2px}.card{border-radius:9px}}
...
window.CASE_MODULE_VERSIONS=window.CASE_MODULE_VERSIONS||{};window.CASE_MODULE_VERSIONS['v4450-ux-system']='4.47.0';
