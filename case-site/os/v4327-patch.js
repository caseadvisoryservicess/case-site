...
(function(){
  ...
  function postRender(){
    enforceExternalRole();normalizeBrokerEditors();styleGeoFrame();renderFilterChips();installAdaptiveActions();try{if(typeof window.CASE_SYNC_STICKY==='function')window.CASE_SYNC_STICKY();}catch(_){}
