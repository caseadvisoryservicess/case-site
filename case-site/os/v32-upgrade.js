...
(function(){
  ...
  var T = {
    ru:{
      ...
      addRequest:'Добавить запрос', addInvestorLead:'Добавить инвесторский лид', addAsset:'Добавить объект продажи', addBuyer:'Добавить покупателя', addPartner:'Добавить партнёра',
    ...
    uz:{
      ...
      addRequest:'Soʻrov qoʻshish', addInvestorLead:'Investor lid qoʻshish', addAsset:'Savdo obyekti qoʻshish', addBuyer:'Xaridor qoʻshish', addPartner:'Hamkor qoʻshish',
    ...
    en:{
      ...
      addRequest:'Add request', addInvestorLead:'Add investor lead', addAsset:'Add sale asset', addBuyer:'Add buyer', addPartner:'Add partner',
  ...
  function renderSales(){
    ...
    return pageHead(tr('sales'),tr('salesSub'),'<button class="btn" onclick="v32AssetForm()">+ '+h(tr('addAsset'))+'</button> <button class="btn ghost" onclick="v32BuyerForm()">+ '+h(tr('addBuyer'))+'</button> <button class="btn ghost" onclick="go(\'v32_investors\')">'+h(tr('investorLeads'))+'</button>')+
