...
(function () {
  ...
  function bndInfo() {
    ...
    var e = estimateDistrict(curDist), r = e.rows.filter(function (x) { return x.key === curMah.key; })[0];
...
window.CASE_MODULE_VERSIONS = window.CASE_MODULE_VERSIONS || {}; window.CASE_MODULE_VERSIONS['v4770-geo-mahalla'] = '4.78.0';
